...
import 'package:my_app/demo/welcome_demo/utils/Flutkart.dart';
import 'package:my_app/demo/welcome_demo/utils/MyNavigator.dart';
import 'package:my_app/demo/welcome_demo/widgets/Walkthrough.dart';
                ...
                FlatButton(
                  child: Text(lastPage ? "" : Flutkart.skip,
                      style: TextStyle(
                          ...
                          fontSize: 16.0)),
                  onPressed: () => lastPage ? null : MyNavigator.goToHome(context),
                ),
                FlatButton(
